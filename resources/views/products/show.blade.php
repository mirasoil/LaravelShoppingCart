...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <strong>Name: </strong> {{ $product->name }} <!--- preluam din products numele --->
        </div>
        <div class="form-group">
            <strong>Code: </strong> {{ $product->code }} <!--- preluam din products numele --->
        </div>
        <div class="form-group">
            <strong>Price: </strong> {{ $product->price }} <!--- preluam din products numele --->
        </div>
        <div class="form-group">
